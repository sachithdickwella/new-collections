 ...
 */
public class AdjacentListGraph<V> implements Graph<V> {
     ...
     */
    @Override
    public boolean containsAll(Collection<V> elements) {
        return false;
    }

    /**
     * Return an exact copy of this {@link Collection<V>} with new reference details.
     *
     * @return a new instance of this {@link Collection<V>}.
     */
    @Override
    public Collection<V> copy() {
        return null;
    }
     ...
     */
    @Override
    public <T> T[] toArray(T[] collector) {
        return null;
    }
}
